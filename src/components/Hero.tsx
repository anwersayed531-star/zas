import { Globe, Sparkles, Languages, HelpCircle, Star, Heart } from "lucide-react";
    ...
    <div className="relative overflow-hidden bg-gradient-hero py-20 px-4">
      ...
      <div className="relative max-w-6xl mx-auto text-center space-y-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-8">
          ...
          <a href="https://forms.gle/uLRoAkhvVYxHSY7R7" target="_blank" rel="noopener noreferrer">
            <Button 
              size="lg"
              variant="outline"
              className="text-lg px-8 py-6 bg-white/10 text-white border-white/30 hover:bg-white/20"
            >
              ...
              {translations.nav[language].rateUs}
            </Button>
          </a>
          <a href="https://paypal.me/ZAS476" target="_blank" rel="noopener noreferrer">
            <Button 
              size="lg"
              variant="outline"
              className="text-lg px-8 py-6 bg-white/10 text-white border-white/30 hover:bg-white/20"
            >
              ...
              {translations.nav[language].supportUs}
            </Button>
          </a>
        </div>
